...
class TestLuaStateStackApi(unittest.TestCase, TestHelper):
    ...
    def test_pushBoolean(self):
        ...
        self.assertTrue(self.getStackInfo(False)[-1])

    def test_pushInteger(self):
        self.ls.PushInteger(10)
        self.assertEqual(self.getStackInfo(False)[-1], 10)

    def test_pushNil(self):
        self.ls.PushNil()
        self.assertEqual(self.getStackInfo(False)[-1], 'nil')

    def test_pushString(self):
        self.ls.PushString('hello')
        self.assertEqual(self.getStackInfo(False)[-1].value, 'hello')

    def test_pushValue(self):
        prevalue = self.getStackInfo(False)[-4]
        self.ls.PushValue(-4)
        self.assertEqual(self.getStackInfo(False)[-1], prevalue)

    def test_remove(self):
        prevalue = self.getStackInfo(False)[-3]
        self.ls.Remove(-3)
        self.assertNotEqual(self.getStackInfo(False)[-3], prevalue)

    def test_replace(self):
        prevalue = self.getStackInfo(False)[2]
        self.ls.Replace(3)
        with self.assertRaises(ValueError):
            self.getStackInfo(False).index(prevalue)
        self.assertEqual(self.getStackInfo(False)[-1], True)

    def test_setTop(self):
        self.ls.SetTop(6)
        self.assertEqual(len(self.getStackInfo(False)), 6)
        self.assertEqual(self.getStackInfo(False)[-1], 'nil')
        self.ls.SetTop(-5)
        self.assertEqual(len(self.getStackInfo(False)), 2)
        self.assertEqual(self.getStackInfo(False)[-1], 10)

    def test_arith_add(self):
        self.addBaseItems()
        self.ls.Arith(ARIOPENUM.LUA_OPADD.value)
        self.assertEqual(self.getStackInfo(False)[-1], 7.0)
        self.removeAllItems()

    def test_arith_sub(self):
        self.addBaseItems()
        self.ls.Arith(ARIOPENUM.LUA_OPSUB.value)
        self.assertEqual(self.getStackInfo(False)[-1], -1.0)
        self.removeAllItems()

    def test_arith_bnot(self):
        self.addBaseItems()
        self.ls.Arith(ARIOPENUM.LUA_OPBNOT.value)
        self.assertEqual(self.getStackInfo(False)[-1], -5)
        self.removeAllItems()

    def test_arith_mod(self):
        self.addBaseItems()
        self.ls.Arith(ARIOPENUM.LUA_OPMOD.value)
        self.assertEqual(self.getStackInfo(False)[-1], 3)
        self.removeAllItems()
    ...
    def test_arith_band(self):
        ...
        self.assertEqual(self.getStackInfo(False)[-1], 12)
        self.removeAllItems()
    ...
    def test_concatNumber(self):
        ...
        self.ls.Concat(2)
        self.assertEqual(self.getStackInfo(False)[-1].value, '23')
        self.removeAllItems()
    ...
    def test_concatString(self):
        ...
        self.ls.Concat(2)
        self.assertEqual(self.getStackInfo(False)[-1].value, 'hello world')
        self.removeAllItems()
