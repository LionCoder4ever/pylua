...
class LuaParser ( Parser ):
    ...
    class StatcallContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatcall" ):
                listener.enterStatcall(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatcall" ):
                listener.exitStatcall(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatcall" ):
                return visitor.visitStatcall(self)
            else:
                return visitor.visitChildren(self)


    class StatforeachContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatforeach" ):
                listener.enterStatforeach(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatforeach" ):
                listener.exitStatforeach(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatforeach" ):
                return visitor.visitStatforeach(self)
            else:
                return visitor.visitChildren(self)


    class StatsemicolonContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatsemicolon" ):
                listener.enterStatsemicolon(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatsemicolon" ):
                listener.exitStatsemicolon(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatsemicolon" ):
                return visitor.visitStatsemicolon(self)
            else:
                return visitor.visitChildren(self)


    class StatbreakContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatbreak" ):
                listener.enterStatbreak(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatbreak" ):
                listener.exitStatbreak(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatbreak" ):
                return visitor.visitStatbreak(self)
            else:
                return visitor.visitChildren(self)


    class StatgotoContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatgoto" ):
                listener.enterStatgoto(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatgoto" ):
                listener.exitStatgoto(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatgoto" ):
                return visitor.visitStatgoto(self)
            else:
                return visitor.visitChildren(self)


    class StatlocalfuncContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatlocalfunc" ):
                listener.enterStatlocalfunc(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatlocalfunc" ):
                listener.exitStatlocalfunc(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatlocalfunc" ):
                return visitor.visitStatlocalfunc(self)
            else:
                return visitor.visitChildren(self)


    class StatlocalContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatlocal" ):
                listener.enterStatlocal(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatlocal" ):
                listener.exitStatlocal(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatlocal" ):
                return visitor.visitStatlocal(self)
            else:
                return visitor.visitChildren(self)


    class StatwhileContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatwhile" ):
                listener.enterStatwhile(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatwhile" ):
                listener.exitStatwhile(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatwhile" ):
                return visitor.visitStatwhile(self)
            else:
                return visitor.visitChildren(self)


    class StatdoContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatdo" ):
                listener.enterStatdo(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatdo" ):
                listener.exitStatdo(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatdo" ):
                return visitor.visitStatdo(self)
            else:
                return visitor.visitChildren(self)


    class StatglobalfuncContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatglobalfunc" ):
                listener.enterStatglobalfunc(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatglobalfunc" ):
                listener.exitStatglobalfunc(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatglobalfunc" ):
                return visitor.visitStatglobalfunc(self)
            else:
                return visitor.visitChildren(self)
    ...
    class StatassignContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatassign" ):
                listener.enterStatassign(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatassign" ):
                listener.exitStatassign(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatassign" ):
                return visitor.visitStatassign(self)
            else:
                return visitor.visitChildren(self)


    class StatifContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatif" ):
                listener.enterStatif(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatif" ):
                listener.exitStatif(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatif" ):
                return visitor.visitStatif(self)
            else:
                return visitor.visitChildren(self)


    class StatrepeatContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatrepeat" ):
                listener.enterStatrepeat(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatrepeat" ):
                listener.exitStatrepeat(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitStatrepeat" ):
                return visitor.visitStatrepeat(self)
            else:
                return visitor.visitChildren(self)


    class StatforContext(StatContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterStatfor" ):
                listener.enterStatfor(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitStatfor" ):
                listener.exitStatfor(self)
    ...
    def stat(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = LuaParser.StatsemicolonContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 82
                ...
                localctx = LuaParser.StatassignContext(self, localctx)
                ...
                localctx = LuaParser.StatcallContext(self, localctx)
                ...
                localctx = LuaParser.StatlabelContext(self, localctx)
                ...
                localctx = LuaParser.StatbreakContext(self, localctx)
                ...
                localctx = LuaParser.StatgotoContext(self, localctx)
                ...
                localctx = LuaParser.StatdoContext(self, localctx)
                ...
                localctx = LuaParser.StatwhileContext(self, localctx)
                ...
                localctx = LuaParser.StatrepeatContext(self, localctx)
                ...
                localctx = LuaParser.StatifContext(self, localctx)
                ...
                localctx = LuaParser.StatforContext(self, localctx)
                ...
                localctx = LuaParser.StatforeachContext(self, localctx)
                ...
                localctx = LuaParser.StatglobalfuncContext(self, localctx)
                ...
                localctx = LuaParser.StatlocalfuncContext(self, localctx)
                ...
                localctx = LuaParser.StatlocalContext(self, localctx)
